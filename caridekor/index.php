                ...
                <div class="row">
                    <div class="col-lg-5">
                        <div class="book-a-car">
                            <form id="query" action="dekor_query.php" method="post">
                                <!--== Pick Up Date ==-->
                        ...
                        <div class="display-table">
                            <div class="display-table-cell">
                                <div class="slider-right-text">
                                    <h1>Pesan Dekor Sekarang</h1>
                                    <p>Nikmati dekorasi dari para ahli <br> Menghias bak taman surgawi</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="display-table">
                        <div class="display-table-cell">
                            <div class="about-content">
                                ...
                                <p>Kami menampilkan dekorasi dari berbagai tempat dan mengumpulkannya jadi satu untuk kamu. Kamu bisa pilih dekorasi yang paling bagus menurutmu atau yang paling pas dikantongmu.</p>
                                <div class="about-btn">
                                    <a href="#">Cari Dekor</a>
                ...
                <div class="col-lg-8 col-md-12 m-auto">
                    <div class="testimonial-content">
                        ...
                        <div class="single-testimonial">
                            <p>caridekor.com membantu saya menemukan dekor untuk pernikahan anak saya. Cepat dan dapat dipercaya.</p>
                            <h3>Ukhtea Onee-chan</h3>
                        ...
                        <!--== Single Testimoial Start ==-->
                        <div class="single-testimonial">
                            <p>Saya butuh dekorasi untuk acara peluncuran motor harley davidson saya untuk 400 tamu. caridekor.com membantu saya menemukan vendor yang cocok.</p>
                            <h3>Ngarang Aksara</h3>
                            <div class="client-logo">
                        ...
                        <!--== Single Testimoial Start ==-->
                        <div class="single-testimonial">
                            <p>Cari dekorasi pengajian h-1 bisa dicari di caridekor.com. Jelas, cepat dan harganya pasti.</p>
                            <h3>Ketua Panitia Pengajian dadakan</h3>
                            <div class="client-logo">
